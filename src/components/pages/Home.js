    ...
    <>
      ...
      <div className={'container-fluid transition-slow my-auto' + (showLoader ? ' disabled-div' : '')}>
        <div className="row justify-content-center">
          <div className="col-12 col-sm-9 col-md-6 text-right home-lottie">
            <HomeAnimation />
        ...
        <div className="row justify-content-center">
          <div className={'col-11 col-md-7 my-2 text-center font-weight-bold bg-success text-white py-2 bg-primary '+ (successMessage ? '' : ' hide')}>
